...
class Coro(object):
    ...
    def suspend(self, timeout=None, alarm_value=None):
        ...
        """
        if self._asyncoro:
            return self._asyncoro._suspend(self, timeout, alarm_value)
        else:
    ...
    def resume(self, update=None):
        ...
        """
        if self._asyncoro:
            return self._asyncoro._resume(self, update)
        else:
...
class AsynCoro(object):
    ...
    def _suspend(self, coro, timeout, alarm_value):
